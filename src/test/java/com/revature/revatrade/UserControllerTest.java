...
public class UserControllerTest {
	...
	public static final String API_JWT = "/api/testjwt";
	...
	@Test
	public void testJWT_whenNoAuthGranted_throwException() {
		ResponseEntity<Object> response = jwtAuth("Authorization", Object.class);
		assertThat(response.getStatusCode()).isEqualTo(HttpStatus.BAD_REQUEST);
	}

	/*************************************************************
	 * Spring Security tests for Validators Left in for posterity
	 *************************************************************/
...
//	}
	...
	public <T> ResponseEntity<T> jwtAuth(Object request, Class<T> response) {
		return testRestTemplate.getForEntity(API_JWT, response, request);
	}
}
